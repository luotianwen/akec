...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/akec/reportStandbook/jxslist">报台信息列表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="reportStandbook"   method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="surgeryGrade" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
