...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/akec/tProduct/">产品信息列表</a></li>
		<li class="active"><a href="${ctx}/akec/tProduct/form?id=${tProduct.id}">产品信息<shiro:hasPermission name="akec:tProduct:edit">${not empty tProduct.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="akec:tProduct:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tProduct" action="${ctx}/akec/tProduct/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="akec:tProduct:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
